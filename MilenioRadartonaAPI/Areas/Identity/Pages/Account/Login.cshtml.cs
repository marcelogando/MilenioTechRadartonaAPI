...
namespace MilenioRadartonaAPI.Areas.Identity.Pages.Account
{
    ...
    public class LoginModel : PageModel
    {
        ...
        public LoginModel(SignInManager<MilenioRadartonaAPIUser> signInManager, ILogger<LoginModel> logger)
        {
        ...
        public class InputModel
        {
            ...
            [Display(Name = "Deseja ser lembrado?")]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    _logger.LogWarning("Conta do usuário trancada.");
